  ...
  const problems = [
    {
      ...
      description: "We have a proven track record of success",
    },
    {
    ...
    },
    {
      ...
      description: "Your goals, our expertise. Tell us your vision",
    },
  ];
  ...
  const getAllPortfoliosProjects = async () => {
    try {
      ...
      if (success) {
        ...
        console.error(message); // Handle case when success is false
      }
    } catch (error) {
